...
enum opt_code
{
  ...
  OPT_m128bit_long_double = 1270,            /* -m128bit-long-double */
  OPT_m16 = 1271,                            /* -m16 */
  OPT_m32 = 1272,                            /* -m32 */
  OPT_m3dnow = 1273,                         /* -m3dnow */
  OPT_m3dnowa = 1274,                        /* -m3dnowa */
  OPT_m64 = 1275,                            /* -m64 */
  OPT_m80387 = 1276,                         /* -m80387 */
  OPT_m8bit_idiv = 1277,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1278,             /* -m96bit-long-double */
  OPT_mabi_ = 1279,                          /* -mabi= */
  OPT_mabm = 1280,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1281,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1282,                 /* -maddress-mode= */
  OPT_madx = 1283,                           /* -madx */
  OPT_maes = 1284,                           /* -maes */
  OPT_malign_data_ = 1285,                   /* -malign-data= */
  OPT_malign_double = 1286,                  /* -malign-double */
  OPT_malign_functions_ = 1287,              /* -malign-functions= */
  OPT_malign_jumps_ = 1288,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1289,                  /* -malign-loops= */
  OPT_malign_stringops = 1290,               /* -malign-stringops */
  OPT_march_ = 1291,                         /* -march= */
  OPT_masm_ = 1292,                          /* -masm= */
  OPT_mavx = 1293,                           /* -mavx */
  OPT_mavx2 = 1294,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1295,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1296,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1297,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1298,                  /* -mavx5124vnniw */
  OPT_mavx512bitalg = 1299,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1300,                      /* -mavx512bw */
  OPT_mavx512cd = 1301,                      /* -mavx512cd */
  OPT_mavx512dq = 1302,                      /* -mavx512dq */
  OPT_mavx512er = 1303,                      /* -mavx512er */
  OPT_mavx512f = 1304,                       /* -mavx512f */
  OPT_mavx512ifma = 1305,                    /* -mavx512ifma */
  OPT_mavx512pf = 1306,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1307,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1308,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1309,                      /* -mavx512vl */
  OPT_mavx512vnni = 1310,                    /* -mavx512vnni */
  OPT_mavx512vpopcntdq = 1311,               /* -mavx512vpopcntdq */
  OPT_mbmi = 1312,                           /* -mbmi */
  OPT_mbmi2 = 1313,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1314,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1315,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1316,                    /* -mcet-switch */
  OPT_mcld = 1317,                           /* -mcld */
  OPT_mcldemote = 1318,                      /* -mcldemote */
  OPT_mclflushopt = 1319,                    /* -mclflushopt */
  OPT_mclwb = 1320,                          /* -mclwb */
  OPT_mclzero = 1321,                        /* -mclzero */
  OPT_mcmodel_ = 1322,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1323, */                    /* -mcpu= */
  OPT_mcrc32 = 1324,                         /* -mcrc32 */
  OPT_mcx16 = 1325,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1326,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1327,            /* -mdump-tune-features */
  OPT_mf16c = 1328,                          /* -mf16c */
  OPT_mfancy_math_387 = 1329,                /* -mfancy-math-387 */
  OPT_mfentry = 1330,                        /* -mfentry */
  OPT_mfentry_name_ = 1331,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1332,               /* -mfentry-section= */
  OPT_mfma = 1333,                           /* -mfma */
  OPT_mfma4 = 1334,                          /* -mfma4 */
  OPT_mforce_drap = 1335,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1336,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1337,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1338,                       /* -mfpmath= */
  OPT_mfsgsbase = 1339,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1340,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1341, */              /* -mfused-madd */
  OPT_mfxsr = 1342,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1343,             /* -mgeneral-regs-only */
  OPT_mgfni = 1344,                          /* -mgfni */
  OPT_mhard_float = 1345,                    /* -mhard-float */
  OPT_mhle = 1346,                           /* -mhle */
  OPT_miamcu = 1347,                         /* -miamcu */
  OPT_mieee_fp = 1348,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1349,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1350,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1351,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1352,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1353,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1354,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1355, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1356,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1357,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1358,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1359,                /* -mlong-double-80 */
  OPT_mlwp = 1360,                           /* -mlwp */
  OPT_mlzcnt = 1361,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1362,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1363,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1364,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1365,                  /* -mmitigate-rop */
  OPT_mmmx = 1366,                           /* -mmmx */
  OPT_mmovbe = 1367,                         /* -mmovbe */
  OPT_mmovdir64b = 1368,                     /* -mmovdir64b */
  OPT_mmovdiri = 1369,                       /* -mmovdiri */
  OPT_mmpx = 1370,                           /* -mmpx */
  OPT_mms_bitfields = 1371,                  /* -mms-bitfields */
  OPT_mmwaitx = 1372,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1373,            /* -mno-align-stringops */
  OPT_mno_default = 1374,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1375,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1376,                  /* -mno-push-args */
  OPT_mno_red_zone = 1377,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1378,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1379,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1380,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1381,                          /* -mpc32 */
  OPT_mpc64 = 1382,                          /* -mpc64 */
  OPT_mpc80 = 1383,                          /* -mpc80 */
  OPT_mpclmul = 1384,                        /* -mpclmul */
  OPT_mpcommit = 1385,                       /* -mpcommit */
  OPT_mpconfig = 1386,                       /* -mpconfig */
  OPT_mpku = 1387,                           /* -mpku */
  OPT_mpopcnt = 1388,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1389, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1390,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1391,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1392,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1393,                        /* -mprfchw */
  OPT_mptwrite = 1394,                       /* -mptwrite */
  OPT_mpush_args = 1395,                     /* -mpush-args */
  OPT_mrdpid = 1396,                         /* -mrdpid */
  OPT_mrdrnd = 1397,                         /* -mrdrnd */
  OPT_mrdseed = 1398,                        /* -mrdseed */
  OPT_mrecip = 1399,                         /* -mrecip */
  OPT_mrecip_ = 1400,                        /* -mrecip= */
  OPT_mrecord_mcount = 1401,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1402,                 /* -mrecord-return */
  OPT_mred_zone = 1403,                      /* -mred-zone */
  OPT_mregparm_ = 1404,                      /* -mregparm= */
  OPT_mrtd = 1405,                           /* -mrtd */
  OPT_mrtm = 1406,                           /* -mrtm */
  OPT_msahf = 1407,                          /* -msahf */
  OPT_msgx = 1408,                           /* -msgx */
  OPT_msha = 1409,                           /* -msha */
  OPT_mshstk = 1410,                         /* -mshstk */
  OPT_mskip_rax_setup = 1411,                /* -mskip-rax-setup */
  OPT_msoft_float = 1412,                    /* -msoft-float */
  OPT_msse = 1413,                           /* -msse */
  OPT_msse2 = 1414,                          /* -msse2 */
  OPT_msse2avx = 1415,                       /* -msse2avx */
  OPT_msse3 = 1416,                          /* -msse3 */
  OPT_msse4 = 1417,                          /* -msse4 */
  OPT_msse4_1 = 1418,                        /* -msse4.1 */
  OPT_msse4_2 = 1419,                        /* -msse4.2 */
  OPT_msse4a = 1420,                         /* -msse4a */
  /* OPT_msse5 = 1421, */                    /* -msse5 */
  OPT_msseregparm = 1422,                    /* -msseregparm */
  OPT_mssse3 = 1423,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1424,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1425, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1426,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1427, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1428,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1429,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1430,            /* -mstringop-strategy= */
  OPT_mstv = 1431,                           /* -mstv */
  OPT_mtbm = 1432,                           /* -mtbm */
  OPT_mtls_dialect_ = 1433,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1434,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1435,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1436,                         /* -mtune= */
  OPT_mvaes = 1437,                          /* -mvaes */
  OPT_mveclibabi_ = 1438,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1439,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1440,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1441,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1442,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1443,                      /* -mwbnoinvd */
  OPT_mx32 = 1444,                           /* -mx32 */
  OPT_mxop = 1445,                           /* -mxop */
  OPT_mxsave = 1446,                         /* -mxsave */
  OPT_mxsavec = 1447,                        /* -mxsavec */
  OPT_mxsaveopt = 1448,                      /* -mxsaveopt */
  OPT_mxsaves = 1449,                        /* -mxsaves */
  OPT_n = 1450,                              /* -n */
  OPT_no_canonical_prefixes = 1451,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1452,              /* -no-integrated-cpp */
  OPT_no_pie = 1453,                         /* -no-pie */
  OPT_nocpp = 1454,                          /* -nocpp */
  OPT_nodefaultlibs = 1455,                  /* -nodefaultlibs */
  OPT_nolibc = 1456,                         /* -nolibc */
  OPT_nophoboslib = 1457,                    /* -nophoboslib */
  OPT_nostartfiles = 1458,                   /* -nostartfiles */
  OPT_nostdinc = 1459,                       /* -nostdinc */
  OPT_nostdinc__ = 1460,                     /* -nostdinc++ */
  OPT_nostdlib = 1461,                       /* -nostdlib */
  OPT_o = 1462,                              /* -o */
  OPT_p = 1463,                              /* -p */
  OPT_pass_exit_codes = 1464,                /* -pass-exit-codes */
  /* OPT_pedantic = 1465, */                 /* -pedantic */
  OPT_pedantic_errors = 1466,                /* -pedantic-errors */
  OPT_pg = 1467,                             /* -pg */
  OPT_pie = 1468,                            /* -pie */
  OPT_pipe = 1469,                           /* -pipe */
  OPT_print_file_name_ = 1470,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1471,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1472,          /* -print-multi-directory */
  OPT_print_multi_lib = 1473,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1474,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1475,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1476,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1477,               /* -print-prog-name= */
  OPT_print_search_dirs = 1478,              /* -print-search-dirs */
  OPT_print_sysroot = 1479,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1480,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1481,                          /* -quiet */
  OPT_r = 1482,                              /* -r */
  OPT_remap = 1483,                          /* -remap */
  OPT_s = 1484,                              /* -s */
  OPT_save_temps = 1485,                     /* -save-temps */
  OPT_save_temps_ = 1486,                    /* -save-temps= */
  OPT_shared = 1487,                         /* -shared */
  OPT_shared_libgcc = 1488,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1489,               /* -shared-libphobos */
  /* OPT_specs = 1490, */                    /* -specs */
  OPT_specs_ = 1491,                         /* -specs= */
  OPT_static = 1492,                         /* -static */
  OPT_static_libasan = 1493,                 /* -static-libasan */
  OPT_static_libgcc = 1494,                  /* -static-libgcc */
  OPT_static_libgfortran = 1495,             /* -static-libgfortran */
  OPT_static_libgo = 1496,                   /* -static-libgo */
  OPT_static_liblsan = 1497,                 /* -static-liblsan */
  OPT_static_libmpx = 1498,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1499,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1500,               /* -static-libphobos */
  OPT_static_libstdc__ = 1501,               /* -static-libstdc++ */
  OPT_static_libtsan = 1502,                 /* -static-libtsan */
  OPT_static_libubsan = 1503,                /* -static-libubsan */
  OPT_static_pie = 1504,                     /* -static-pie */
  /* OPT_std_c__03 = 1505, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1506, */                /* -std=c++0x */
  OPT_std_c__11 = 1507,                      /* -std=c++11 */
  OPT_std_c__14 = 1508,                      /* -std=c++14 */
  OPT_std_c__17 = 1509,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1510, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1511, */                /* -std=c++1z */
  OPT_std_c__2a = 1512,                      /* -std=c++2a */
  OPT_std_c__98 = 1513,                      /* -std=c++98 */
  OPT_std_c11 = 1514,                        /* -std=c11 */
  OPT_std_c17 = 1515,                        /* -std=c17 */
  /* OPT_std_c18 = 1516, */                  /* -std=c18 */
  /* OPT_std_c1x = 1517, */                  /* -std=c1x */
  OPT_std_c2x = 1518,                        /* -std=c2x */
  /* OPT_std_c89 = 1519, */                  /* -std=c89 */
  OPT_std_c90 = 1520,                        /* -std=c90 */
  OPT_std_c99 = 1521,                        /* -std=c99 */
  /* OPT_std_c9x = 1522, */                  /* -std=c9x */
  OPT_std_f2003 = 1523,                      /* -std=f2003 */
  OPT_std_f2008 = 1524,                      /* -std=f2008 */
  OPT_std_f2008ts = 1525,                    /* -std=f2008ts */
  OPT_std_f2018 = 1526,                      /* -std=f2018 */
  OPT_std_f95 = 1527,                        /* -std=f95 */
  OPT_std_gnu = 1528,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1529, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1530, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1531,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1532,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1533,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1534, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1535, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1536,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1537,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1538,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1539,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1540, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1541, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1542,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1543, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1544,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1545,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1546, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1547, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1548,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1549, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1550, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1551, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1552, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1553, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1554,                     /* -std=legacy */
  OPT_symbolic = 1555,                       /* -symbolic */
  OPT_t = 1556,                              /* -t */
  OPT_time = 1557,                           /* -time */
  OPT_time_ = 1558,                          /* -time= */
  OPT_traditional = 1559,                    /* -traditional */
  OPT_traditional_cpp = 1560,                /* -traditional-cpp */
  OPT_trigraphs = 1561,                      /* -trigraphs */
  OPT_u = 1562,                              /* -u */
  OPT_undef = 1563,                          /* -undef */
  OPT_v = 1564,                              /* -v */
  OPT_version = 1565,                        /* -version */
  OPT_w = 1566,                              /* -w */
  OPT_wrapper = 1567,                        /* -wrapper */
  OPT_x = 1568,                              /* -x */
  OPT_z = 1569,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,

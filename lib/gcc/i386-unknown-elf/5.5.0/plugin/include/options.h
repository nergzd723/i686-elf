...
enum opt_code
{
  ...
  OPT_mhle = 1196,                           /* -mhle */
  OPT_mieee_fp = 1197,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1198,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1199,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1200,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1201, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1202,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1203,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1204,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1205,                /* -mlong-double-80 */
  OPT_mlwp = 1206,                           /* -mlwp */
  OPT_mlzcnt = 1207,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1208,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1209,              /* -mmemset-strategy= */
  OPT_mmmx = 1210,                           /* -mmmx */
  OPT_mmovbe = 1211,                         /* -mmovbe */
  OPT_mmpx = 1212,                           /* -mmpx */
  OPT_mms_bitfields = 1213,                  /* -mms-bitfields */
  OPT_mmwaitx = 1214,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1215,            /* -mno-align-stringops */
  OPT_mno_default = 1216,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1217,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1218,                  /* -mno-push-args */
  OPT_mno_red_zone = 1219,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1220,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1221,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1222,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1223,                          /* -mpc32 */
  OPT_mpc64 = 1224,                          /* -mpc64 */
  OPT_mpc80 = 1225,                          /* -mpc80 */
  OPT_mpclmul = 1226,                        /* -mpclmul */
  OPT_mpcommit = 1227,                       /* -mpcommit */
  OPT_mpopcnt = 1228,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1229,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1230,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1231,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1232,                        /* -mprfchw */
  OPT_mpush_args = 1233,                     /* -mpush-args */
  OPT_mrdrnd = 1234,                         /* -mrdrnd */
  OPT_mrdseed = 1235,                        /* -mrdseed */
  OPT_mrecip = 1236,                         /* -mrecip */
  OPT_mrecip_ = 1237,                        /* -mrecip= */
  OPT_mrecord_mcount = 1238,                 /* -mrecord-mcount */
  OPT_mred_zone = 1239,                      /* -mred-zone */
  OPT_mregparm_ = 1240,                      /* -mregparm= */
  OPT_mrtd = 1241,                           /* -mrtd */
  OPT_mrtm = 1242,                           /* -mrtm */
  OPT_msahf = 1243,                          /* -msahf */
  OPT_msha = 1244,                           /* -msha */
  OPT_mskip_rax_setup = 1245,                /* -mskip-rax-setup */
  OPT_msoft_float = 1246,                    /* -msoft-float */
  OPT_msse = 1247,                           /* -msse */
  OPT_msse2 = 1248,                          /* -msse2 */
  OPT_msse2avx = 1249,                       /* -msse2avx */
  OPT_msse3 = 1250,                          /* -msse3 */
  OPT_msse4 = 1251,                          /* -msse4 */
  OPT_msse4_1 = 1252,                        /* -msse4.1 */
  OPT_msse4_2 = 1253,                        /* -msse4.2 */
  OPT_msse4a = 1254,                         /* -msse4a */
  /* OPT_msse5 = 1255, */                    /* -msse5 */
  OPT_msseregparm = 1256,                    /* -msseregparm */
  OPT_mssse3 = 1257,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1258,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1259,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1260,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1261,            /* -mstringop-strategy= */
  OPT_mtbm = 1262,                           /* -mtbm */
  OPT_mtls_dialect_ = 1263,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1264,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1265,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1266,                         /* -mtune= */
  OPT_mveclibabi_ = 1267,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1268,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1269,                    /* -mvzeroupper */
  OPT_mx32 = 1270,                           /* -mx32 */
  OPT_mxop = 1271,                           /* -mxop */
  OPT_mxsave = 1272,                         /* -mxsave */
  OPT_mxsavec = 1273,                        /* -mxsavec */
  OPT_mxsaveopt = 1274,                      /* -mxsaveopt */
  OPT_mxsaves = 1275,                        /* -mxsaves */
  OPT_n = 1276,                              /* -n */
  OPT_no_canonical_prefixes = 1277,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1278,              /* -no-integrated-cpp */
  OPT_nocpp = 1279,                          /* -nocpp */
  OPT_nodefaultlibs = 1280,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1281,                   /* -nostartfiles */
  OPT_nostdinc = 1282,                       /* -nostdinc */
  OPT_nostdinc__ = 1283,                     /* -nostdinc++ */
  OPT_nostdlib = 1284,                       /* -nostdlib */
  OPT_o = 1285,                              /* -o */
  OPT_p = 1286,                              /* -p */
